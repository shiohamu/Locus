 ...
 */
export function assertNumberOrNull(value: unknown, fieldName: string): number | null {
  if (isNull(value)) {
    return null;
  }
  if (!isNumber(value)) {
 ...
 */
export function assertNoteCoreRow(
  row: unknown
): ReturnType<typeof isNoteCoreRow> extends true ? Parameters<typeof isNoteCoreRow>[0] : never {
 ...
 */
export function assertLinkRow(
  row: unknown
): ReturnType<typeof isLinkRow> extends true ? Parameters<typeof isLinkRow>[0] : never {
  if (!isLinkRow(row)) {
 ...
 */
export function assertNoteMDRow(
  row: unknown
): ReturnType<typeof isNoteMDRow> extends true ? Parameters<typeof isNoteMDRow>[0] : never {
  if (!isNoteMDRow(row)) {
 ...
 */
export function assertRSSFeedRow(
  row: unknown
): ReturnType<typeof isRSSFeedRow> extends true ? Parameters<typeof isRSSFeedRow>[0] : never {
  if (!isRSSFeedRow(row)) {
 ...
 */
export function assertRSSItemRow(
  row: unknown
): ReturnType<typeof isRSSItemRow> extends true ? Parameters<typeof isRSSItemRow>[0] : never {
  if (!isRSSItemRow(row)) {
 ...
 */
export function assertWebClipRow(
  row: unknown
): ReturnType<typeof isWebClipRow> extends true ? Parameters<typeof isWebClipRow>[0] : never {
  if (!isWebClipRow(row)) {
 ...
 */
export function assertLLMProvider(value: unknown, fieldName: string): LLMProvider {
  if (
    !isString(value) ||
